...
if __name__ == '__main__':
    ...
    path = "/btfidr/data/20130824/013/cam2"
    ...
    mean_overhead_time = numpy.average(mean_overhead_time) / 1000.

    print('Total overhead time: {0:.2f}'.format(mean_overhead_time - exp_time - readout_time))