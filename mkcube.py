        ...
        for i in range(imDepth):
            ...
            try: 
                ...
                try: 
                    ...
                    try: 
                        frame = pyfits.getdata(current_file)
                    except IndexError:
                        print(" Warning: %s file corrupted." % current_file)
                        frame = numpy.zeros_like(cube[0])
            for s in range(bin_step):
                frame = (frame - dark - bias) / flat
            ...
            for j in range(images_per_channel):
                ...
                try: 
                    ...
                    try: 
                        ...
                        print(" Warning: %s file corrupted." % current_file)
                        frame = numpy.zeros_like(cube[0])
                dummy_cube[j,:,:] = (frame - dark - bias) / flat
