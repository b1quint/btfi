...
"""
    ...
    v2.0.2 - A 'main' function was created to organize better the code.
...
def main():
    ...
    header.update('CRVAL3', header['FPZINIT']);
    
    header.update('CDELT1', bin_step)
    header.update('CDELT2', bin_step)
    header.update('CDELT3', header['FPZDELT']);
